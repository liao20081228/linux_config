...
autocmd FileType  c let g:ycm_global_ycm_extra_conf="~/Downloads/linux_config/ycm_files/ycm_extra_conf_c.py"
autocmd FileType cpp,python let g:ycm_global_ycm_extra_conf="~/Downloads/linux_config/ycm_files/ycm_extra_conf_cpp.py"
